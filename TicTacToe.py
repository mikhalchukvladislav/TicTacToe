def main():
    ...
    if first_player == 'x' or first_player == 'X':
        ...
        while (full_field == False) and (result_who_win == False):
            ...
            if (len(coord_x) != 2) or (coord_x[0] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_x[1] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_x in check_coord):
                while (len(coord_x) != 2) or (coord_x[0] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_x[1] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_x in check_coord):
            ...
            if (len(coord_0) != 2) or (coord_0[0] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_0[1] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_0 in check_coord):
                while (len(coord_0) != 2) or (coord_0[0] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_0[1] not in [str(i) for i in range(len(field_x0) - 1)]) or (coord_0 in check_coord):
